...
<div class="row justify-content-sm-center">
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/sport/volleyball/volleyball2026.JPG" title="Волейбол, наша команда" class="img-fluid rounded z-depth-1" %}
    </div>
</div>